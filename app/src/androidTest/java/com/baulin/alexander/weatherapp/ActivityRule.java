...
/**
 * A JUnit {@link Rule @Rule} which launches an activity when your TestMap starts. Stop extending
 ...
 * }</pre>
 *
 * This will automatically launch the activity for each TestMap method. The instance will also be
...
public class ActivityRule<T extends Activity> implements TestRule {
    ...
    /**
     * Get the {@link Instrumentation} instance for this TestMap.
     */
